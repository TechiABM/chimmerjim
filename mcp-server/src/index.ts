...
server.tool(
  ...
  async () => {
    ...
    const summary = [
      ...
      `  public/heroes/hero-home-desktop.webp   Home hero — landscape`,
      `  public/heroes/hero-home-mobile.webp    Home hero — portrait (mobile)`,
      `  public/heroes/hero-metro.webp          Metro page hero`,
      `  public/heroes/hero-service.webp        Service page hero`,
      `  public/heroes/hero-metro-service.webp  Metro+service page hero`,
      `  public/heroes/hero-ads.webp            Ads lander hero`,
      ``,
      `## Removed Features`,
