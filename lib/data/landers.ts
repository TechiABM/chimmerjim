...
export const landers: AdsLander[] = [
  // ─── Existing campaigns (carried over with preset: "default") ────
  {
    ...
    heroSubtitle:
      "Cracked crowns, damaged masonry, leaking flashing, and fireplace issues repaired across DC, MD & VA. NFPA-certified technicians. Free written estimate. Same-day slots available.",
    keyword: "chimney repair washington dc",
    city: "Washington DC",
    state: "DC",
    phone: "2025553300",
    trustPoints: [
      "Licensed & insured in DC, MD & VA",
      "Same-day & next-day slots open",
      "Free written estimate — on the spot",
      "4.9 stars · 500+ verified reviews",
    ],
    bullets: [
      "Chimney crown crack repair & rebuild",
      "Mortar repointing & tuckpointing",
      "Flashing repair & full replacement",
      "Spalling & loose brick repair",
      "Damper repair & replacement",
      "Chimney cap supply & installation",
      "Smoke chamber parging",
      "Waterproofing & vapor-permeable sealant",
    ],
    urgency: "Limited same-day slots available — call now to schedule",
    proofStat: "Most DC chimney repairs diagnosed and quoted in a single visit",
    midCtaHeading: "Get your chimney repaired this week",
    midCtaSub: "Same-day slots open in DC, MD & VA. Free written estimate before any work starts.",
    ...
    problems: [
      ...
      "Leaking flashing where chimney meets the roof",
      "White efflorescence staining on the brick",
      "Damper stuck open, closed, or broken",
    ],
    processSteps: [
      {
        title: "Call — we pick up fast",
        desc: "Speak to a real ChimmerJim dispatcher. We confirm your DC, MD, or VA address, triage the issue, and lock in same-day or next-day arrival.",
      },
      {
        title: "On-site diagnosis",
        desc: "An NFPA-certified technician inspects crown, mortar, flashing, cap, damper, and liner. Camera-assisted if needed. Full picture in one visit.",
      },
      {
        title: "Free written quote",
        desc: "Flat-rate, itemized estimate before any work starts. Urgent repairs clearly separated from cosmetic ones. No pressure — valid for 60 days.",
      },
      {
        title: "Repair completed",
        desc: "Most chimney repairs in the DC metro are completed on the same or next visit. We clean up and leave you with a written warranty.",
      },
    ],
    reviews: [
      {
        ...
        text: "Crown was cracked and letting water pour into our fireplace every time it rained. ChimmerJim came out same day, gave us a written quote on the spot, and had it fully repaired by the next morning. No more leaks.",
      },
      {
        name: "David L.",
        location: "Bethesda, MD",
        text: "Flashing was the culprit — water stains on our ceiling gave it away. They found it in 20 minutes, replaced the flashing and resealed the crown the same visit. Honest, fast, and reasonably priced.",
      },
      {
        name: "Susan K.",
    ...
    faqs: [
      {
        q: "Do you repair chimneys in Washington DC, Maryland, and Virginia?",
        a: "Yes — ChimmerJim serves the full DC metro: Washington DC, Montgomery County, Prince George's County, Arlington, Alexandria, Fairfax, and surrounding areas. Same-day and next-day appointments available.",
      },
      {
        q: "How much does chimney repair cost in DC?",
        a: "Minor repairs (cap replacement, damper swap) start around $200. Crown repair runs $300–$700. Full tuckpointing on a two-story chimney is $800–$3,000+ depending on extent. We give you a flat-rate written quote before any work starts.",
      },
      {
        q: "Can you repair a leaking chimney?",
        a: "Yes. Chimney leaks in DC homes are most commonly caused by a cracked crown, failed step flashing, or deteriorated mortar joints. We diagnose the exact source and repair it — not just mask it.",
      },
      {
        q: "My chimney is over 50 years old. Can it be repaired or does it need to be replaced?",
        a: "Most older DC-area chimneys — even pre-war rowhouse stacks — can be repaired rather than replaced. We assess the structural condition and give you an honest repair-vs-rebuild recommendation.",
      },
      {
        q: "How fast can I get an appointment?",
        a: "We typically have same-day or next-day availability across the DC metro. Call now to check current slots.",
      },
    ],
  },
  {
